...
{
    internal class OpenSkyApiModel5
    {
        [JsonPropertyName("time")]
        public int Time { get; set; }
        [JsonPropertyName("states")]
        public List<OpenSkyApiModelData5> States { get; set; }
    }

    internal class OpenSkyApiModelData5
    {
        /*
           * {
           "time" : 1727456063,
       ...
       */
        ...
        public string Spi { get; set; }  //safety performance indicator
